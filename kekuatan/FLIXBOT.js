...
reply(' SUKSES MODE PUBLIC MATUR SUKSMA')
}
break
case 'self': {
if (!isCreator) return mess.owner
...
Done Bwang Kuhhh Kamu Sekarang Sudah Bisa Mengakses Power-MD Abangkuhh Btw Limit Gada Reset Reset an Jika Limit Habis Silahkan Buy Limit Di ZxD`
veri = m?.sender
if (!m.isGroup) {
...
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = true
reply('SUCCES PUBLIC KAK MATUR SUKSMA')
}
break
case 'self': {
if (!isCreator) return reply(mess.owner) 
Fernazerini.public = false
reply('SUCCES SELF KAK MATUR SUKSMA')
}
break
...
if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
const gan = ['10% banyak" perawatan ya bang:v\nCanda Perawatan:v','30% Semangat bang Merawat Dirinya><','20% Semangat Ya bang👍','40% Wahh bang><','50% abang Ganteng deh><','60% Hai Ganteng🐊','70% Hai Ganteng🐊','62% Bang Ganteng><','74% abang ni ganteng deh><','83% Love You abang><','97% Hai Ganteng🐊','100% Bang lu anomali ya','29% Semangat Bang:)','94% Hai Ganteng><','75% Hai Bang Ganteng','82% wihh abang Pasti Sering Perawatan kan??','41% Semangat:)','39% Lebih Semangat🐊']
...
if (!isPrem && global.db.data.users[sender].limit < 1) return reply('Maaf Kak Limit Anda Habis Ingin Membeli Limit Ketik .buylimit')
             db.data.users[sender].limit -= 1 // -1 limit
                reply('1 Limit Anda Terpakai')
const can = ['10% banyak" perawatan ya kak:v\nCanda Perawatan:v','30% Semangat Kaka Merawat Dirinya><','20% Semangat Ya Kaka👍','40% Wahh Kaka><','50% kaka cantik deh><','60% Hai Cantik🐊','70% Hai Ukhty🐊','62% Kakak Cantik><','74% Kakak ni cantik deh><','83% Love You Kakak><','97% Aduhai Cantiknya🐊','100% Ambatukamm','29% Semangat Kakak:)','94% Hai Cantik><','75% Hai Kakak Cantik','82% wihh Kakak Pasti Sering Perawatan kan??','41% Semangat:)','39% Lebih Semangat🐊']
...
'Kata orang, cowok yang nggak mau pergi Sembahyang itu tidsk akan mencapai MOKSA.',
